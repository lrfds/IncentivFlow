...
export class ProjectionWorker {
  ...
  constructor() {
    this.worker = new Worker<ProjectionJob>(
      'projections',
  ...
  private async projectEvent(aggregateId: string, eventType: string) {
  ...
  private async updateReadModel(aggregateId: string, state: any) {
  ...
  private async handlePhaseChange(aggregateId: string, state: any) {
